      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <h3 className="font-semibold">What are your shipping options?</h3>
              <p className="text-muted-foreground">
                We offer standard shipping (3-5 business days), express shipping (1-2 business days), and international shipping options. Free shipping is available on orders over $100.
              </p>
            </div>
            <div className="space-y-2">
              <h3 className="font-semibold">What is your return policy?</h3>
              <p className="text-muted-foreground">
                We accept returns within 30 days of purchase. Items must be in original condition with all packaging. Some restrictions apply to certain products.
              </p>
            </div>
            <div className="space-y-2">
              <h3 className="font-semibold">Do you offer bulk discounts?</h3>
              <p className="text-muted-foreground">
                Yes, we offer volume discounts for bulk orders. Please contact our sales team for a custom quote based on your requirements.
              </p>
            </div>
            <div className="space-y-2">
