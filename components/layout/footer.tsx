      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-600">
              Quality electronic components for every project. Serving hobbyists, professionals, and businesses since 2010.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/shop?category=tools" className="text-gray-600 hover:text-gray-900">
                  Tools
                </Link>
              </li>
              <li>
                <Link href="/shop?category=accessories" className="text-gray-600 hover:text-gray-900">
                  Accessories
                </Link>
              </li>
              <li>
                <Link href="/shop?category=components" className="text-gray-600 hover:text-gray-900">
                  Components
                </Link>
              </li>
              <li>
                <Link href="/shop?category=power-products" className="text-gray-600 hover:text-gray-900">
                  Power Products
                </Link>
              </li>
              <li>
                <Link href="/shop?category=test-measurements" className="text-gray-600 hover:text-gray-900">
                  Test & Measurements
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-sm text-gray-500 text-center">
            &copy; {new Date().getFullYear()} KG-Components. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
