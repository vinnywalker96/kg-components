...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 457)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var cjs = __webpack_require__(734);
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 434, 23)).then(({ default: WS })=>{
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 457))).Response;
        }
        return Response;
    });
...
var browser = __webpack_require__(457);
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2Ftmp%2Fvinnywalker96%2Fkg-components&matchers=&preferredRegion=&middlewareConfig=e30%3D!
...
// @ts-ignore
const node_fetch_1 = __importDefault(__webpack_require__(457));
const PostgrestError_1 = __importDefault(__webpack_require__(378));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(189));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(959));
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(726));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(664));
...
const version_1 = __webpack_require__(394);
...
const PostgrestClient_1 = __importDefault(__webpack_require__(680));
